...
if (document.getElementById('slider')) {
    ...
    let rangeSliderValueElementEth = document.getElementById('slider-range-value-eth');
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
        if (values[handle] == 0) {
            rangeSliderValueElement.innerHTML = `Free`;
        } else {
            rangeSliderValueElement.innerHTML = `${Math.round(values[handle])} UPS`;
        }
        rangeSliderValueElementEth.innerHTML = `${values[handle] / 100} ETH`;
...
if (document.getElementById('promote-slider')) {
    ...
    let rangeSliderValueElementPromote = document.getElementById('slider-range-promote-value');
    let rangeSliderValueElementPromoteEth = document.getElementById('slider-range-promote-value-eth');
    ...
    rangeSliderPromote.noUiSlider.on('update', function (values, handle) {
        ...
        if (values[handle] == 0) {
            rangeSliderValueElementPromote.innerHTML = `Free`;
        } else {
            rangeSliderValueElementPromote.innerHTML = `${Math.round(values[handle])} UPS`;
        }
        rangeSliderValueElementPromoteEth.innerHTML = `${values[handle] / 100} ETH`;
...
if (window.innerWidth > 1200) {
  $(window).scroll(function () {
    ...
    var sidebar = $('.create-preview');
    if (height < 220) {
      $(sidebar).css('top', (220 - height) + 'px');
    } else {
      $(sidebar).css('top', '20' + 'px');
    }
  });
}
